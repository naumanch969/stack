    ...
    return (
        ...
        <div style={{ margin: '3rem 0' }} className="flex justify-center items-center my-[3rem] " >
            <Accordion
                ...
                className="bg-inherit w-[35rem] border-[1px] border-gray-300 rounded-[10px] "
                open={taskState.openTaskAccordion}
                onChange={showAccordionForm}
            >

                <AccordionSummary expandIcon={<ExpandMore className="text-gray-300 " />} className="border-b-[1px] border-b-gray-300  " style={{ height: '3rem', background: 'inherit', borderRadius: '2px' }} >
                ...
                <AccordionDetails style={{ background: `#${taskState.taskData.bg.hex || 'inherit'}` }} className="w-full flex flex-col gap-4" >
                    ...
                    <div className="mt-[12px] " >
                        <input
                            className="w-full text-[#a4a2a5] rounded-[5px] placeholder-[#a4a2a5] w-full bg-transparent text-[#a4a2a5] text-[19px] font-medium focus:outline-none "
                            style={{ color: '#a4a2a5' }}
                            autoComplete='off'
                            name="title"
                            placeholder="Title"
