        ...
        <div className="w-full flex flex-col justify-between items-end gap-[8px] mb-[4px] " >
            ...
            <div className="flex justify-between items-center gap-[1rem] " >
                ...
                <div style={{ padding: '2px', gap: '4px' }} className="flex justify-center items-center   p-[2px] gap-[4px]  " >
                    <button onClick={() => setActivityState({ ...activityState, isGridView: true })} className={`hover:bg-gray-600 text-gray-100 rounded-[4px] ${activityState.isGridView && 'bg-gray-600'} `} ><GridViewRounded className="text-[30px]" style={{ fontSize: '30px' }} /></button>
                    <button onClick={() => setActivityState({ ...activityState, isGridView: false })} className={`hover:bg-gray-600 text-gray-100 rounded-[4px] ${!activityState.isGridView && 'bg-gray-600'} `} ><TableRows className="text-[30px]" style={{ fontSize: '30px' }} /></button>
                </div>
            </div>
