...
import { createActivity, updateActivity, addLink, updateLink, deleteLink, updateHeading, updateText, addImage, deleteImage, updateBg } from "../../actions/activity"
        ...
        <div className="w-[56%]  absolute top-[50%] left-[50%] transform translate-x-[-50%] translate-y-[-50%] p-4 " >
            ...
            >
                ...
                <AccordionSummary expandIcon={<ExpandMore className="text-gray-300 " />} className="bg-gray-900 border-b-[1px] border-b-gray-300  " style={{ height: '3rem', background: '#202124', borderRadius: '2px', borderBottom: '1px solid gray' }} >
                    <p className='text-[30px] text-gray-300 ' >{currentDate} {limitText(Months[currentMonth + 1], 3)}, {currentYear} {'  '} {limitText(Days[currentDay + 1], 3)} {'  '} {currentHour}:{currentMinute} </p>
                </AccordionSummary>
                ...
                <AccordionDetails style={{ background: `#${activityState.activityData.bg.hex || 'inherit'}` }} className="w-full flex flex-col gap-4 h-[24rem] overflow-y-scroll p-0 pt-[12px] " >
                    ...
                    <div style={{ background: `#${activityState.activityData.bg.hex || 'inherit'}` }} className="w-full flex flex-col gap-[10px] rounded-[4px]  pt-[12px] " >
                        ...
                        {
                            showColors &&
                            <div className="bg-black flex justify-between  bg-gray-300 rounded-[8px] p-[2px] " >
                                <Tooltip title="Default" placement="bottom" >
                                    <DoNotDisturb onClick={() => handleSetColor('gray-900', '202124')} style={{ fontSize: '30px' }} className={` cursor-pointer text-[#a4a2a5]  text-[40px] `} />
                                </Tooltip>
                        ...
                        <div className="  flex flex-col gap-[8px]  " >
                            {
                                activityState.activityData?.activity.map((timeLapse, index) => (
                                    ...
                                    <div key={index} className="relative bg-black flex items-start gap-[5px] p-[5px] text-gray-100 rounded-[4px] " >
