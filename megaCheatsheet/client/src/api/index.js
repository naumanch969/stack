...
// user
export const signUp = (userData) => { return API.post("/user/signUp", userData) }       // { firstName, lastName, email, password, confirmPassword, date }
export const login = (userData) => { return API.put("/user/login", userData) }          // { email, password, date } 
