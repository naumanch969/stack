...
const Like = ({ likes }) => {
    ...
    const hasLikedCodeBlock = likes.findIndex((id) => id === user._id)
    ...
    if (likes.length > 0) {
        return hasLikedCodeBlock !== -1
            ...
            (
                <>
                    <ThumbUpAlt fontSize="small" className="text-gray-400" />
                    {likes.length > 2
                        ?
        ...
        return (
            <>
                <ThumbUpAltOutlined fontSize="small" className="text-gray-400 " /> Like
            </>
        )
    }
