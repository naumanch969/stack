...
export const getTask = async (req, res) => {
    try {
        ...
        console.log('error in getTask - controllers', error)
...
export const getAllTasks = async (req, res) => {
    try {
        ...
        console.log('error in getAllTasks - controllers', error)
...
export const updateTask = async (req, res) => {
    try {
        ...
        console.log('error in updatetask - controllers', error)
...
export const bookmarkTask = async (req, res) => {
    try {
        ...
        console.log('error in bookmarktask - controllers', error)
...
export const deleteTask = async (req, res) => {
    try {
        ...
        console.log('error in deleteTask - controllers', error)
...
export const deleteAllTasks = async (req, res) => {
    try {
        ...
        console.log('error in deleteAllTasks - controllers', error)
