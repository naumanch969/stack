...
export const getActivity = async (req, res) => {
    try {
        ...
        console.log(' error in getActivity - controllers ', error)
...
export const getActivities = async (req, res) => {
    try {
        ...
        console.log(' error in getActivities - controllers ', error)
...
export const getUserActivity = async (req, res) => {
    try {
        ...
        console.log('error in getUserActivities - controllers', error)
...
export const createActivity = async (req, res) => {
    try {
        ...
        if (!userId) res.status(401).json({ message: 'unautorized - you have to login first' })
            ...
            if (arr.includes(1)) {
                console.log(`activity of date ${date.date} has already been created`)
        ...
        console.log(' error in createActivity - controllers ', error)
...
export const addImage = async (req, res) => {
    try {
        ...
        console.log(' error in addImage - controllers ', error)
...
export const deleteImage = async (req, res) => {
    try {
        ...
        console.log(' error in deleteImage - controllers ', error)
...
export const updateText = async (req, res) => {
    try {
        ...
        console.log(' error in addText - controllers ', error)
...
export const updateHeading = async (req, res) => {
    try {
        ...
        console.log(' error in updateHeading - controllers ', error)
...
export const addLink = async (req, res) => {
    try {
        ...
        console.log(' error in addLink - controllers ', error)
...
export const updateLink = async (req, res) => {
    try {
        ...
        console.log(' error in updateLink - controllers ', error)
...
export const deleteLink = async (req, res) => {
    try {
        ...
        console.log(' error in deleteLink - controllers ', error)
...
export const updateBg = async (req, res) => {
    try {
        ...
        console.log(' error in updateBg - controllers ', error)
...
export const updateActivity = async (req, res) => {
    try {
        ...
        console.log(' error in updateActivity - controllers ', error)
...
export const deleteActivity = async (req, res) => {
    try {
        ...
        console.log('error in deleteActiviY - controllers', error)
...
export const deleteActivities = async (req, res) => {
    try {
        ...
        console.log(' error in deleteAllActivities - controllers ', error)
