        ...
        <div className="w-full h-full flex flex-col gap-[1rem] p-[1rem] " >
            {
                Boolean(otherUsers.length)
                    ...
                    <div className='w-full flex flex-col gap-[1rem] px-[1rem] '  >
                        <PageHeading heading='Find friend' />
                    ...
                    :
                    <div className=" " >
                        <p className="text-center font-semibold text-text-gray md:px-[5rem] text-[20px] " >No account to show</p>
                    </div>
            }
        </div>
    )
