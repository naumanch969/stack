...
import { addLink, updateLink, deleteLink, updateHeading, updateText, addImage, deleteImage } from "../../../../redux/actions/activity"
    ...
    return (
        <>
            ...
            <div className="mb-[16px] "  >
                <h4 className="text-purple-300 text-[26px] text-bold " variant="h6">Today's Activity</h4>
            ...
            {/* Complete Block */}
            <div style={{ background: `#${activityState.activityData.bg.hex || 'inherit'}` }} className="w-full flex flex-col gap-[10px] border-[1px] border-purple-300 rounded-[4px] p-[5px] pt-[12px] " >
                {/* date and time */}
                <div className="text-purple-300 bg-black rounded-[4px] flex justify-between px-[5px] py-[10px] " >
                ...
                <div className="  flex flex-col gap-[8px]  " >
                    {
                        activityState.activityData?.activity.map((timeLapse, index) => (
                            ...
                            <div key={index} style={{ gap: `5px`, padding: `5px`, background: `black` }} className="relative bg-black flex items-start gap-[5px] p-[5px] text-purple-100 rounded-[4px] " >
                                ...
                                <div
                                    ...
                                    className={`bg-gray rounded-[4px] p-[6px] relative border-b-[1px] border-purple-300 w-full flex flex-col justify-center items-center `}
                                >
