import { AddAlertOutlined, ColorLens, Image, MoreVertOutlined, Circle, DoNotDisturb, ExpandMore, Cancel, Tune, AddLink, Title } from '@mui/icons-material'
...
import { createActivity, updateActivity, addLink, updateLink, deleteLink, updateHeading, updateText, addImage, deleteImage, updateBg } from "../../../../redux/actions/activity"
...
const UpdateForm = () => {
    ...
    //////////////////////////// STATES ////////////////////////////////////
    const [background, setBackground] = useState({ color: ``, hex: `` })
    ...
    const handleImageButtonClick = (time) => {
    ...
    return (
        <div className="w-[56%]  absolute top-[50%] left-[50%] transform translate-x-[-50%] translate-y-[-50%] p-4 " >
            <Accordion
                ...
                className="bg-inherit w-full border-[1px] border-purple-300 rounded-[10px] "
                expanded={activityState.openActAccordForUpdate}
                onChange={openActAccordForUpdate}
            >

                <AccordionSummary expandIcon={<ExpandMore className="text-purple-300 " />} className="bg-purple-900 border-b-[1px] border-b-purple-300  " style={{ height: '3rem', background: '#202124', borderRadius: '2px', borderBottom: '1px solid gray' }} >
                    <p className='text-[30px] text-purple-300 ' >{currentDate} {limitText(Months[currentMonth + 1], 3)}, {currentYear} {'  '} {limitText(Days[currentDay + 1], 3)} {'  '} {currentHour}:{currentMinute} </p>
                </AccordionSummary>

                <AccordionDetails style={{ background: `#${activityState.activityData.bg.hex || 'inherit'}` }} className="w-full flex flex-col gap-4 h-[24rem] overflow-y-scroll p-0 pt-[12px] " >


                    <div style={{ background: `#${activityState.activityData.bg.hex || 'inherit'}` }} className="w-full flex flex-col gap-[10px] rounded-[4px]  pt-[12px] " >
                            ...
                            <div className="flex gap-4  " >
                                ...
                                <div className="" >
                                    <Tooltip title="Remind Me" placement="bottom" >
                                        <AddAlertOutlined style={{ fontSize: '22px', color: '#a4a2a5' }} className="text-[22px] text-[#a4a2a5]  " />
                                    </Tooltip>
                                </div>
                                {/* color picker icon button */}
                                <div className="relative" >
                                    <Tooltip title="Color" placement="bottom" >
                                        <ColorLens onClick={() => setShowColors(pre => !pre)} style={{ fontSize: '26px', color: '#a4a2a5' }} className="text-[26px] text-[#a4a2a5]  " />
                                    </Tooltip>
                                </div>
                                {/* more horiz icon button */}
                                <div className="" >
                                    <Tooltip title="More" placement="bottom" >
                                        <MoreVertOutlined style={{ fontSize: '22px', color: '#a4a2a5' }} className="text-[22px] text-[#a4a2a5]  " />
                                    </Tooltip>
                                </div>
                            </div>
                        ...
                        {
                            showColors &&
                            <div className="flex justify-between  bg-purple-300 rounded-[8px] p-[2px] " >
                                <Tooltip title="Default" placement="bottom" >
                                    <DoNotDisturb onClick={() => handleSetColor('purple-900', '202124')} style={{ fontSize: '30px' }} className={` cursor-pointer text-[#a4a2a5]  text-[40px] `} />
                                </Tooltip>
                                <Tooltip title="Red" placement="bottom" >
                                    <Circle onClick={() => handleSetColor('red', '652826')} style={{ fontSize: '30px' }} className={` cursor-pointer text-red  text-[40px] `} />
                                </Tooltip>
                                <Tooltip title="Dark Blue" placement="bottom" >
                                    <Circle onClick={() => handleSetColor('darkBlue', '0c3b5f')} style={{ fontSize: '30px' }} className={` cursor-pointer text-darkBlue  text-[40px] `} />
                                </Tooltip>
                                <Tooltip title="Green" placement="bottom" >
                                    <Circle onClick={() => handleSetColor('green', '245a24')} style={{ fontSize: '30px' }} className={` cursor-pointer text-green  text-[40px] `} />
                                </Tooltip>
                                <Tooltip title="Yellow" placement="bottom" >
                                    <Circle onClick={() => handleSetColor('yellow', '655d1a')} style={{ fontSize: '30px' }} className={` cursor-pointer text-yellow  text-[40px] `} />
                                </Tooltip>
                                <Tooltip title="Gray" placement="bottom" >
                                    <Circle onClick={() => handleSetColor('gray', '3b3f43')} style={{ fontSize: '30px' }} className={` cursor-pointer text-gray  text-[40px] `} />
                                </Tooltip>
                                <Tooltip title="Orange" placement="bottom" >
                                    <Circle onClick={() => handleSetColor('orange', '492e18')} style={{ fontSize: '30px' }} className={` cursor-pointer text-orange  text-[40px] `} />
                                </Tooltip>
                                <Tooltip title="Brown" placement="bottom" >
                                    <Circle onClick={() => handleSetColor('brown', '674917')} style={{ fontSize: '30px' }} className={` cursor-pointer text-brown  text-[40px] `} />
                                </Tooltip>
                                <Tooltip title="Purple" placement="bottom" >
                                    <Circle onClick={() => handleSetColor('purple', '47265d')} style={{ fontSize: '30px' }} className={` cursor-pointer text-purple  text-[40px] `} />
                                </Tooltip>
                                <Tooltip title="Teal" placement="bottom" >
                                    <Circle onClick={() => handleSetColor('teal', '00514c')} style={{ fontSize: '30px' }} className={` cursor-pointer text-teal  text-[40px] `} />
                                </Tooltip>
                                <Tooltip title="Blue" placement="bottom" >
                                    <Circle onClick={() => handleSetColor('blue', '16565f')} style={{ fontSize: '30px' }} className={` cursor-pointer text-blue  text-[40px] `} />
                                </Tooltip>
                                <Tooltip title="Pink" placement="bottom" >
                                    <Circle onClick={() => handleSetColor('pink', '641e43')} style={{ fontSize: '30px' }} className={` cursor-pointer text-pink  text-[40px] `} />
                                </Tooltip>
                            </div>
                        }
                        {/* time lapses */}
                        <div className="  flex flex-col gap-[8px]  " >
                            {
                                activityState.activityData?.activity.map((timeLapse, index) => (
                                    ...
                                    <div key={index} className="relative bg-black flex items-start gap-[5px] p-[5px] text-purple-100 rounded-[4px] " >
                                        ...
                                        <div
                                            ...
                                            className={`bg-gray rounded-[4px] p-[6px] relative   w-full flex flex-col justify-center items-center `}
                                        >
                                            ...
                                            <div className="w-full flex items-start flex-col  " >
                                                {
                                                    timeLapse.clickedHeading
                                                        ...
                                                        <input
                                                            ...
                                                            className={`bg-blue capitalize mb-[4px] text-[32px] bg-inherit outline-none w-[15rem] border-b-[1px] border-purple-300  `}
                                                            ref={headingRef}
                                                        />
                                                        :
                                                        <h4
                                                ...
                                                }
                                                {
                                                    ...
                                                    <div className="flex gap-[4px] mb-[6px] " >
                                                        <input
                                                            ...
                                                            ref={headingRef}
                                                            style={{ textTransform: `capitalize`, fontSize: `32px` }}
                                                            className={`bg-inherit capitalize text-[32px] outline-none w-[15rem] border-b-[1px] border-purple-300   `}
                                                        />
                                                    </div>
                                                }
                                            </div>
                                                            ...
                                                            <span className="flex flex-col" >
                                                                {
                                                                    timeLapse.clickedLink.link == li.link
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            className={`mb-[4px] bg-inherit outline-none w-[15rem] border-b-[1px] border-purple-300 ${TLLinkValue.includes(' ') && 'border-red'} `}
                                                                            ref={linkRef}
                                                                        />
                                                                        :
                                                    ...
                                                    <div className="flex gap-[4px] " >
                                                        ...
                                                        <div className="" >
                                                            <input
                                                                ...
                                                                className={`bg-inherit outline-none w-[15rem] border-b-[1px] border-purple-300 ${TLLinkValue.includes(' ') && 'border-red'} `}
                                                                ref={linkRef}
                                                            />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="flex justify-between items-center p-[1px] gap-[12px] rounded-[2px] " >
                                                        <div ref={containerRef} id="filebase_image" className=" " >
                                                            <Tooltip placement="top" title="Add Image">
                                                                <Image onClick={() => handleImageButtonClick(timeLapse.time)} className="text-[16px] text-purple-100 hover:bg-purple-800 rounded-[2px] cursor-pointer p-[1px] " />
                                                            </Tooltip>
                                                        ...
                                                        <Tooltip placement="top" title="random" >
                                                            <MoreVertOutlined className="text-[16px] text-purple-100 hover:bg-purple-800 rounded-[2px] cursor-pointer p-[1px] " />
                                                        </Tooltip>
                                                        <Tooltip placement="top" title="random" >
                                                            <AddAlertOutlined className="text-[16px] text-purple-100 hover:bg-purple-800 rounded-[2px] cursor-pointer p-[1px] " />
                                                        </Tooltip>
                                                        <Tooltip placement="top" title="Link" >
                                                            <AddLink onClick={() => linkIconClick(timeLapse.time)} className="text-[16px] text-purple-100 hover:bg-purple-800 rounded-[2px] cursor-pointer p-[1px] " />
                                                        </Tooltip>
                                                        <Tooltip placement="top" title="Heading" >
                                                            <Title onClick={() => headingIconClick(timeLapse.time)} className="text-[16px] text-purple-100 hover:bg-purple-800 rounded-[2px] cursor-pointer p-[1px] " />
                                                        </Tooltip>
                                                        <Tooltip placement="top" title="Random" >
                                                            <ColorLens className="text-[16px] text-purple-100 hover:bg-purple-800 rounded-[2px] cursor-pointer p-[1px] " />
                                                        </Tooltip>
                                                    </div>
                                                }
                                            </div>
