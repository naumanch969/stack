                ...
                <div className="flex justify-between items-center w-full " >
                    ...
                    <div className="flex justify-between items-center gap-[1rem] " >
                        <button onClick={handleCreateNoteClick} style={{ width: '34px', height: '34px' }} className='flex items-center justify-center bg-black rounded-full w-[34px] h-[34px]  ' >
                            <Add style={{ rotate: showCreateNoteForm && '45deg' }} className={`text-purple-300 ${showCreateNoteForm && 'rotate-45'} `} />
                        </button>
                    </div>

                    <div className='flex justify-between items-center gap-[16px] mr-[12px] ' >
                        <button onClick={() => typeButtonClick('all')} className={`w-[72px] h-[32px] rounded-[6px] ${noteState.type == 'all' && 'bg-purple-900 text-purple-300 '} `} >All</button>
                        <button onClick={() => typeButtonClick('project')} className={`w-[72px] h-[32px] rounded-[6px] ${noteState.type == 'project' && 'bg-purple-900 text-purple-300 '} `} >Project</button>
                        <button onClick={() => typeButtonClick('business')} className={`w-[72px] h-[32px] rounded-[6px] ${noteState.type == 'business' && 'bg-purple-900 text-purple-300 '} `} >Business</button>
                        <button onClick={() => typeButtonClick('personal')} className={`w-[72px] h-[32px] rounded-[6px] ${noteState.type == 'personal' && 'bg-purple-900 text-purple-300 '} `} >Personal</button>
                    </div>
